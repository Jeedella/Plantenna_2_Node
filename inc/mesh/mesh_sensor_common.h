...
#define GET_SENSOR(ID)({(ID == SENSOR_ALL_PROP_ID ? SENSOR_ALL_IDX : (ID == SENSOR_AIRFLOW_PROP_ID ? SENSOR_AIRFLOW_IDX :(ID==SENSOR_BME_TEMP_PROP_ID ? SENSOR_BME_TEMP_IDX : (ID==SENSOR_BME_HUMI_PROP_ID ? SENSOR_BME_HUMI_IDX : (ID == SENSOR_BME_PRES_PROP_ID ? SENSOR_BME_PRES_IDX : (ID==SENSOR_BATTERY_PROP_ID ? SENSOR_BATTERY_IDX ? (ID==SENSOR_TEST_PROP_ID ? SENSPR_TEST_IDX : 0xFF))))) })))
